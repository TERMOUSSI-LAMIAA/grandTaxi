...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html"><span>GrandTaxi</span></a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>   
         <li><a class="nav-link scrollto active" href="#hero">Home</a></li>
          ...
          @auth
          @role("admin")
          <li><a class="nav-link scrollto" href="{{ url('/dashboard_a') }}">Dashboard</a></li>
           @endrole
            @role("driver")
          <li><a class="nav-link scrollto" href="{{ url('/dashboard_d') }}">Dashboard</a></li>
           @endrole
          @role("passenger")
          <li><a class="nav-link scrollto" href="{{ url('/dashboard_p') }}">Dashboard</a></li>
           @endrole
          @else
      ...
      <div class="row justify-content-between">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            <h1>Build Your Landing Page With <span>GrandTaxi</span></h1>
