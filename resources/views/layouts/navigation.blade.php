<nav x-data="{ open: false }" class="bg-white dark:bg-amber-500 border-b border-gray-100 dark:border-amber-500">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @role('admin')
                        ...
                        <x-nav-link :href="route('gestPassenger')" :active="request()->routeIs('gestPassenger')">
                            {{ __('Passengers') }}
                        </x-nav-link>
                    @endrole
                    @role('passenger')
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard_d')" :active="request()->routeIs('dashboard_d')">
                {{ __('Dashboard') }}
